...
<div className="relative w-[85%] md:w-[95%] xl:w-[80%] 2xl:w-[70%] max-w-[1400px] mx-auto">        <div className="relative aspect-[16/9] overflow-hidden rounded-[28px] shadow-[0_25px_60px_rgba(0,0,0,0.08)]">
