    ...
    <section className="py-32 bg-white overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-8 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
        ...
        <div className="lg:col-span-7 relative">
          <div className="aspect-[16/10] bg-[#FAF9F6] rounded-2xl overflow-hidden shadow-2xl">
          </div>
        ...
        <div className="lg:col-span-5 space-y-8">
          <div className="space-y-4">
            <h3 className="text-[#004A30] text-[11px] font-medium tracking-[0.3em] uppercase">Hikayemiz</h3>
