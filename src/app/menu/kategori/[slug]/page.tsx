      ...
      <div className="max-w-[1280px] mx-auto px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {categoryProducts.map((product) => (
            ...
            >
              <div className="aspect-square bg-[#FAF9F6] rounded-[2.5rem] overflow-hidden border border-black/[0.02] transition-all group-hover:shadow-xl group-hover:-translate-y-1">
                <img 
                  src={product.image} 
                  alt={product.name} 
