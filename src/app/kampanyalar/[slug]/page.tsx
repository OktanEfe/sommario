  ...
  return (
    <main className="pt-32 pb-20 bg-white min-h-screen">
      <div className="max-w-[1000px] mx-auto px-8">
        <Link href="/kampanyalar" className="flex items-center gap-2 text-[10px] uppercase tracking-[0.2em] text-black/40 hover:text-[#004A30] transition-colors mb-12">
          <ChevronLeft size={14} /> Tüm Kampanyalara Dön
        </Link>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
          <div className="sticky top-32">
            <div className="aspect-[4/5] rounded-[3rem] overflow-hidden bg-[#FAF9F6] shadow-2xl shadow-black/5 relative">
          ...
          <div className="space-y-10 py-4">
            <div className="space-y-4">
              ...
              <h1 className="text-5xl font-light tracking-tighter leading-tight text-[#231F20]">{campaign.title}</h1>
              <p className="text-xl text-[#004A30] italic font-light">{campaign.subtitle}</p>
            </div>
            <div className="h-[1px] w-full bg-black/5" />
            <div className="prose prose-sm max-w-none">
              <p className="text-lg text-black/60 leading-relaxed font-light">{campaign.content}</p>
            </div>
